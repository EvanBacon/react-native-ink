...
// import EdgeInsetsPropType, { EdgeInsetsProp } from '../EdgeInsetsPropType';
...
import { StyleObj } from '../StyleSheet/StyleSheetTypes';
...
const ViewPropTypes = {
  // CLI
  unstable__transformChildren: func,
  ...
  importantForAccessibility: oneOf([
    'auto',
    'no',
    'no-hide-descendants',
    'yes',
