...
class Program extends EventEmitter {
  ...
  setupDump() {
    ...
    this.output.write = function(data: Buffer) {
  ...
  setupTput() {
    ...
    Object.keys(tput).forEach(key => {
      ...
      if (tput.padding) {
        self.put[key] = function(...args: any[]): any {
          return tput._print(tput[key].apply(tput, args), write);
        };
      } else {
        self.put[key] = function(...args: any[]): any {
          return self._write(tput[key].apply(tput, args));
        };
      }
    });
  }
  ...
  listen() {
    ...
    this.on(
      'newListener',
      // @ts-ignore
      (this._newHandler = function fn(type: string) {
  ...
  _listenInput() {
    ...
    this.input.on(
      'keypress',
      (this.input._keypressHandler = (ch: any, key: any = { ch }) => {
        if (
          key.name === 'undefined' &&
  ...
  onceKey(key: any, listener: Function) {
    if (typeof key === 'string') key = key.split(/\s*,\s*/);
    key.forEach(function(key: string) {
      // @ts-ignore
  ...
  _bindMouse(s: any, buf: any) {
    ...
    if (
      ...
      s = `\x1b[M${String.fromCharCode(b)}${String.fromCharCode(
        x,
  ...
  bindResponse() {
    ...
    this.on('data', (data: Buffer) => {
      const _data = decoder.write(data);
      if (!_data) return;
      this._bindResponse(_data);
    });
  }
  ...
  unkey(key: any, listener: Function) {
    return this.removeKey(key, listener);
  }

  removeKey(key: any, listener: Function) {
    if (typeof key === 'string') key = key.split(/\s*,\s*/);
  ...
  rc(key, hide) {
    return this.restoreCursor(key, hide);
  }
  ...
  cuf(param: any): any {
    return this.cursorForward(param);
  }
  right(param: any): any {
    return this.cursorForward(param);
  }
  ...
  cub(param: any): any {
    return this.cursorBackward(param);
  }
  left(param: any): any {
    return this.cursorBackward(param);
  }
  ...
  ed(param: any): any {
    return this.eraseInDisplay(param);
  }
  ...
  //     Ps.
  sgr(param, val) {
    return this.charAttributes(param, val);
  }
  attr(param, val) {
    return this.charAttributes(param, val);
  }
  ...
  fg(color, val) {
    return this.setForeground(color, val);
  }
  ...
  bg(color, val) {
    return this.setBackground(color, val);
  }
  ...
  dsr(param, callback, dec, noBypass) {
    return this.deviceStatus(param, callback, dec, noBypass);
  }
  ...
  // same as CSI Ps B ?
  cnl(param: any): any {
    return this.cursorNextLine(param);
  }
  ...
  // reuse CSI Ps A ?
  cpl(param: any): any {
    return this.cursorPrecedingLine(param);
  }
  ...
  cha(param: any): any {
    return this.cursorCharAbsolute(param);
  }
  ...
  hpa(param: any): any {
    return this.charPosAbsolute(param);
  }
  charPosAbsolute(param: any): any {
    this.x = param || 0;
    this._ncoords();
    if (this.tput) {
  ...
  // reuse CSI Ps C ?
  hpr(param: any): any {
    return this.HPositionRelative(param);
  }
  ...
  da(param: any, callback: any): any {
    return this.sendDeviceAttributes(param, callback);
  }
  ...
  vpa(param: any): any {
    return this.linePosAbsolute(param);
  }
  linePosAbsolute(param: any): any {
    this.y = param || 1;
    this._ncoords();
    if (this.tput) {
  ...
  // reuse CSI Ps B ?
  vpr(param: any): any {
    return this.VPositionRelative(param);
  }
  ...
  hvp(row: any, col: any): any {
    return this.HVPosition(row, col);
  }
  ...
  //   dow) (DECSTBM).
  // CSI ? Pm r
  decstbm(top: number, bottom: number): any {
    return this.setScrollRegion(top, bottom);
  }
  csr(top: number, bottom: number): any {
    return this.setScrollRegion(top, bottom);
  }
  setScrollRegion(top: number, bottom: number): any {
    if (!this.zero) {
      top = (top || 1) - 1;
  ...
  cht(param: any): any {
    return this.cursorForwardTab(param);
  }
  cursorForwardTab = function(param: any): any {
    // @ts-ignore
    this.x += 8;
    // @ts-ignore
    this._ncoords();
  ...
  scrollUp = function(param: any): any {
    // @ts-ignore
    this.y -= param || 1;
    // @ts-ignore
    this._ncoords();
  ...
  cbt(param: any): any {
    return this.cursorBackwardTab(param);
  }
  ...
  rep(param: any): any {
    return this.repeatPrecedingCharacter(param);
  }
  ...
  decrqm(param: any): any {
    return this.requestAnsiMode(param);
  }
  ...
  decrqmp(param: any): any {
    return this.requestPrivateMode(param);
  }
  ...
  //     Ps = 2  -> 8-bit controls.
  decscl(...args: any[]) {
    return this.setConformanceLevel(...args);
  }
  ...
  decscusr(param: any): any {
    return this.setCursorStyle(param);
  }
  ...
  decsca(param: any): any {
    return this.setCharProtectionAttr(param);
  }
  ...
  deccara(...args: any[]) {
    return this.setAttrInRectangle(...args);
  }
  ...
  decrara(...args: any[]): any {
    return this.reverseAttrInRectangle(...args);
  }
  ...
  decswbv(param: any): any {
    return this.setWarningBellVolume(param);
  }
  ...
  decsmbv(param: any): any {
    return this.setMarginBellVolume(param);
  }
  ...
  // NOTE: xterm doesn't enable this code by default.
  deccra(...args: any[]) {
    return this.copyRectangle(...args);
  }
  ...
  decefr(...args: any[]) {
    return this.enableFilterRectangle(...args);
  }
  ...
  decsace(param: any): any {
    return this.selectChangeExtent(param);
  }
  ...
  // NOTE: xterm doesn't enable this code by default.
  decfra(...args: any[]) {
    return this.fillRectangle(...args);
  }
  ...
  decelr(...args: any[]) {
    return this.enableLocatorReporting(...args);
  }
  enableLocatorReporting(...args: any[]) {
  ...
  // NOTE: xterm doesn't enable this code by default.
  decera(...args: any[]): any {
    return this.eraseRectangle(...args);
  }
  ...
  decsle(...args: any[]): any {
    return this.setLocatorEvents(...args);
  }
  ...
  decsera(...args: any[]): any {
    return this.selectiveEraseRectangle(...args);
  }
  ...
  //   The ``page'' parameter is not used by xterm, and will be omit-
  //   ted.
  decrqlp(param: any, callback: any) {
    return this.requestLocatorPosition(param, callback);
  }
  ...
  // NOTE: xterm doesn't enable this code by default.
  decic(...args: any[]): any {
    return this.insertColumns(...args);
  }
  ...
  // NOTE: xterm doesn't enable this code by default.
  decdc(...args: any[]): any {
    return this.deleteColumns(...args);
  }
...
function unshiftEvent(obj: any, event: any, listener: any) {
...
function merge(out: any) {
  slice.call(arguments, 1).forEach(obj => {
